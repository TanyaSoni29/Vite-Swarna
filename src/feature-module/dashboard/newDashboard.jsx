							...
							<div className='card-body sell-product'>
								...
								<div className='d-flex align-items-center justify-content-between border-bottom'>
									<div className='d-flex align-items-center'>
										...
										>
											<img
												src='assets/img/products/product-16.jpg'
												alt='img'
											/>
										</Link>
										<div className='ms-2'>
							...
							<div className='card-body'>
								<div className='d-flex align-items-center justify-content-between border-bottom mb-3 pb-3 flex-wrap gap-2'>
									<div className='d-flex align-items-center'>
										...
										>
											<img
												src='assets/img/customer/customer11.jpg'
												alt='img'
											/>
										</Link>
										<div className='ms-2'>
								...
								<div className='d-flex align-items-center justify-content-between border-bottom mb-3 pb-3 flex-wrap gap-2'>
									<div className='d-flex align-items-center'>
										...
										>
											<img
												src='assets/img/customer/customer12.jpg'
												alt='img'
											/>
										</Link>
										<div className='ms-2'>
								...
								<div className='d-flex align-items-center justify-content-between border-bottom mb-3 pb-3 flex-wrap gap-2'>
									<div className='d-flex align-items-center'>
										...
										>
											<img
												src='assets/img/customer/customer14.jpg'
												alt='img'
											/>
										</Link>
										<div className='ms-2'>
