...
import {
	refreshGiftCards,
	setGiftCard,
} from '../../core/redux/slices/giftCardSlice';
	...
	const columns = [
		{
			title: 'Card Code',
			dataIndex: 'cardCode',
			sorter: (a, b) => a.cardCode.toLocaleCompare(b.cardCode),
		},
		{
			title: 'Recipient',
			...
			sorter: (a, b) => a.recipientName.toLocaleCompare(b.recipientName),
		},
		{
			title: 'Sender',
			...
			sorter: (a, b) => a.senderName.toLocaleCompare(b.senderName),
		},
		{
			title: 'Issued Date',
			dataIndex: 'issueDate',
		...
		// },
		{
			...
			sorter: (a, b) => new Date(a.redeemedDate) - new Date(b.redeemedDate),
		},
		{
			title: 'Redeemed',
			...
			sorter: (a, b) => a.isRedeemed - b.isRedeemed,
		},
		{
			title: '',
			dataIndex: 'actions',
				...
				<div className='action-table-data'>
					<div className='edit-delete-action'>
						<Link
							...
							to='#'
							onClick={() => dispatch(setGiftCard(giftCards))}
						>
							<i
								data-feather='eye'
				...
				<div className='content'>
					<div className='page-header'>
						...
						<ul className='table-top-head'>
							...
							/>
							<RefreshIcon api={refreshGiftCards} />
							<CollapesIcon />
						</ul>
