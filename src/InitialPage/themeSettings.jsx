											...
											<div className='col-4'>
												<div className='theme-layout mb-3'>
													<input
														...
														onChange={() =>
															handleLayoutChange('without-header')
														}
													/>
										...
										<div className='d-flex align-items-center flex-wrap'>
											...
											<div className='theme-colorselect theme-colorselect-rounded mb-3 me-3'>
												<input
													...
													checked={
														dataTopBar === 'topbarcolorten' ? true : false
													}
													onChange={() =>
										...
										<div className='d-flex align-items-center'>
											...
											<div className='theme-colorselect m-1 me-2'>
												<input
													...
													checked={
														dataSidebar === 'sidebarcolorthirteen'
															? true
															: false
													}
													onChange={() =>
											...
											<div className='theme-colorselect m-1 me-2'>
												<input
													...
													checked={
														dataSidebar === 'sidebarcolorfourteen'
															? true
															: false
													}
													onChange={() =>
										...
										<div className='d-flex align-items-center flex-wrap'>
											<div className='theme-sidebarbg me-3 mb-3'>
												<input
													...
													checked={
														dataSidebarBg === 'sidebarbg1' ? true : false
													}
													onChange={() =>
														handleDataSidebarBgChange('sidebarbg1')
													}
												/>
												<label
													htmlFor='sidebarBg1'
											...
											<div className='theme-sidebarbg me-3 mb-3'>
												<input
													...
													checked={
														dataSidebarBg === 'sidebarbg2' ? true : false
													}
													onChange={() =>
														handleDataSidebarBgChange('sidebarbg2')
													}
												/>
												<label
													htmlFor='sidebarBg2'
											...
											<div className='theme-sidebarbg me-3 mb-3'>
												<input
													...
													checked={
														dataSidebarBg === 'sidebarbg3' ? true : false
													}
													onChange={() =>
														handleDataSidebarBgChange('sidebarbg3')
													}
												/>
												<label
													htmlFor='sidebarBg3'
											...
											<div className='theme-sidebarbg me-3 mb-3'>
												<input
													...
													checked={
														dataSidebarBg === 'sidebarbg4' ? true : false
													}
													onChange={() =>
														handleDataSidebarBgChange('sidebarbg4')
													}
												/>
												<label
													htmlFor='sidebarBg4'
											...
											<div className='theme-sidebarbg me-3 mb-3'>
												<input
													...
													checked={
														dataSidebarBg === 'sidebarbg5' ? true : false
													}
													onChange={() =>
														handleDataSidebarBgChange('sidebarbg5')
													}
												/>
												<label
													htmlFor='sidebarBg5'
											...
											<div className='theme-sidebarbg me-3 mb-3'>
												<input
													...
													checked={
														dataSidebarBg === 'sidebarBg6' ? true : false
													}
													onChange={() =>
														handleDataSidebarBgChange('sidebarBg6')
													}
												/>
												<label
													htmlFor='sidebarBg6'
